...
let outputFile = './dist/topsmap-gl.d.ts';
childProcess.execSync(`dts-bundle-generator --umd-module-name=topsmapgl -o ${outputFile} ./src/index.ts`);
...
console.log('Finifhed bundling types for topsmap-gl starting style-spec');
